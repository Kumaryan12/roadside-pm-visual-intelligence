...
- Self-contained 126-word abstract with no citations (journal maximum: 150 words).
...
- All 12 grayscale artwork files are collected under `figures_submission_grayscale/`; original colour versions remain preserved under `figures_submission/`.
...
1. `main.tex`, `references.bib`, and the complete `figures_submission_grayscale/` folder (manuscript source package).
...
6. The portal-generated Declaration of Competing Interest Word document.
...
The review PDF is intentionally double-spaced and includes extensive appendices. If the editor requests a shorter article, move the provenance, per-date and sensitivity appendices into a supplementary PDF without changing reported values.
